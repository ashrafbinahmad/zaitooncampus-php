        ...
        class CourseDynamic extends React.Component {
            ...
            componentDidMount() {
                getAllData('courses').then((querySnapShot) => {
                    ...
                    let filtered_data = data.filter((item) => item.campus === "Girls").filter((item) => item.url.toLowerCase() === _courseName)
                    ...
                    if (filtered_data[0].campus === "Boys") window.location = "/boys-campus/?course=" + _courseName
            ...
            render() {
                return (
                    <div>
                        {
                            this.state.fetchedData.campus != "Boys" &&
                            <CourseDescription
                                courseName={this.state.fetchedData?.courseName}
                                data={this.state.fetchedData}
                                same_courses={["SCIENCE: Bio-Math & Bio-Psychology", "COMMERCE: Computer Application", "HUMANITIES: Sociology and Political Science"]}
                                ...
                                {
                                    name: "COMMERCE",
                                    link: "/girls-campus/?course=commerce__computer_application"
                                },
                                {
                                    name: "HUMANITIES",
                                    link: "/girls-campus/?course=humanities--sociology-and-political-science"
                                }]
                                }
                            />
                        }
