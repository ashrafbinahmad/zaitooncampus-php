...
<head>
    ...
    <title>Zaitoon Girls Campus, Kottakkal</title>
            ...
            courses = [
                {
                    ...
                    link: "/girls-campus/?course=science__bio_math___bio_psychology",
                ...
                {
                    name: "Zaitoon Graduate Academy: Degree",
                    link: "/girls-campus/?course=zaitoon-graduate-academy",
                    image: "https://shooliniuniversity.com/blog/wp-content/uploads/2022/09/Courses-after-12-Commerce.jpg"
                },
                {
                    name: "Thanzeel: School of Quran",
                    link: "/girls-campus/?course=tanzeel--school-of-quran",
                ...
                {
                    name: "Zaitoon Repeater's Batch: Medical Entrance",
                    link: "/girls-campus/?course=zaitoon-entrance-repeaters",
                    image: "https://www.shutterstock.com/image-photo/healthcare-business-graph-data-growth-600nw-1998168056.jpg",
                },
                {
                    ...
                    <main className='total'>
                        <section className='intro'>
                            ...
                            <div className='container'>
                                ...
                                <h1>
                                    Zaitoon Girls Campus- Kottakkal <br />

                                </h1>
                                <h2>ABOUT US</h2>
                                <p className='about_desc'>
                                    Welcome to Zaitoon International Girls Campus, an oasis of education nestled in the serene
                                    locales of Pang-Chendi at Kottakkal. Our exclusive campus for girls is designed to provide a
                                    secure and inspiring environment for academic and moral growth. Here, in addition to
                                    rigorous NEET and JEE coaching, we instill the teachings of Islamic studies, fostering a
                                    holistic development that transcends traditional education.
                                    <br />
                                    <br />
                                    <br />
                                    At Zaitoon International Girls Campus, our vision is to empower young women to excel
                                    academically and embrace values that guide them through life's journey. The lush
                                    surroundings complement our cutting-edge coaching facilities, creating an atmosphere where
                                    students thrive academically while imbibing the principles of Islamic morality. Join us on this
                                    unique educational voyage where knowledge and character intertwine seamlessly.
                                    <br />
                                    <br />
                        ...
                        <section className='image_sect'>
                            <img src='/assets/images/zaitoon_building.webp' ></img>
                        </section>
                        ...
                        <section className='address_sect'>
                            <div className='address'>
                                ...
                                <h4>Kottakkal, Pang Chendi</h4>
                                <h4>Malappuram, Kerala, </h4>
                                <h4>India, 679 338 </h4>
                            </div>
                            <div className='map'>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d121796.20422149469!2d76.03241662518425!3d10.91347215019991!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7cb0d5c602331%3A0xec1e5de0ed5804a!2sZaitoon%20International%20Girls%20Campus!5e0!3m2!1sen!2sin!4v1680804200016!5m2!1sen!2sin"></iframe></div>
                        </section>
